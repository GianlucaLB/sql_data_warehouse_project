...
BEGIN
	...
	BEGIN TRY
		...
		FROM 'C:\sql\sql-data-warehouse-project\datasets\source_crm\loc_a101.csv'
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'C:\sql\sql-data-warehouse-project\datasets\source_crm\cust_az12.csv'
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'C:\sql\sql-data-warehouse-project\datasets\source_crm\px_cat_g1v2.csv'
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
